...
describe("trimString util", () => {
  ...
  it("Negative trimming cases", () => {
    ...
    //expect(trimString(1234, 4)).toBe("1234...");
  });
});

describe("getIsValidNumber util", () => {
  it("Positive checking cases", () => {
    const numbers = [1, 0, 0.5, "123", "123asd"];
  ...
  it("Negative checking cases", () => {
    const notNumbers = ["asd123", "qwee", Infinity, undefined, null, [], {}];
...
describe("removeObjPropImmutably util", () => {
  ...
  it("Negative checking cases", () => {
    const notValidObjects = [undefined, null, [], {}, 'string', 2];
    for(let int = 1; int < notValidObjects.length.length; int++) {
